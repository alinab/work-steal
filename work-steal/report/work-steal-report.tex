...
\begin{itemize}
    ...
    \item Work-stealing shows high variance at 4 and 8 workers
        ...
        genuinely balanced: even at \texttt{threshold=5000} with 16 workers
        the steal ratio stays just below 10\%, well below the mergesort steal
        ratio of 14 to 16\% at the same worker count, confirming that uniform
        chunk costs keep workers productive locally without frequent stealing.
