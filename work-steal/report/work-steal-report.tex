...
With more time, using profiling tools for cache and memory analysis would have
helped show the details of memory shrinking and expanding for existing
benchmarks; additional benchmarking programs would have broadened our evaluation.
We have attempted an implementation of circular array allocation from a shared
buffer pool as described in section 4 of \cite{chase2005dynamic}. Some initial
outputs from comparing memory manangement after deque shrinking/growing via the
OCaml GC vs using a shared buffer memory pool are here:
(\href{https://github.com/alinab/work-steal/blob/shared-mem-pool-work/work-steal/outputs/mergesort_shrink_shared0_fixed_workers.png}{a848335}),
(\href{https://github.com/alinab/work-steal/blob/shared-mem-pool-work/work-steal/outputs/mergesort_shrink_shared0_resize_ops.png}{a848335}),
(\href{https://github.com/alinab/work-steal/blob/shared-mem-pool-work/work-steal/outputs/mergesort_shrink_shared0_varying_workers.png}{a848335}).
The outputs show <> . This work has also brought up questions such as <>
